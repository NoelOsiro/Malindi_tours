...
import SocialMediaIcons from '@/components/pages/login/SocialMediaIcons';

const BackgroundSection = () => {
  return (
    // Background section with dynamic background image
    <div className="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center" 
        data-testid='background-image' style={{ backgroundImage: "url(https://source.unsplash.com/random/?Malindi)" }}>
