...
interface MainContentProps {
    profileData: IpostData['profiles']
}

const Sidebar: React.FC<MainContentProps> = ({ profileData }) => {
    ...
    const relatedPosts = [
        { title: "While Loop in Javascript", description: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. m, sapiente explicabo!" },
        { title: "Foreach Loop in Javascript", description: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. m, sapiente explicabo!" },
        { title: "Map Loop in Javascript", description: "Lorem ipsum, dolor sit amet consectetur adipisicing elit. m, sapiente explicabo!" }
    ];
    ...
    return (
        <aside className="col-span-2 md:col-span-1 mt-4 md:mt-0">
            <div className="mb-8">
                ...
                <ul className="ml-3 text-lg font-semibold text-gray-700">
                    {categories.map((category, index) => (
                        <li key={index} className="border py-2 px-2 mt-2 mb-1 cursor-pointer hover:text-gray-900 rounded-sm flex justify-between">
                            {category.name}
                        </li>
                    ))}
                </ul>
            ...
            <div id="author-card" className="flex flex-col items-center my-8">
                ...
                <div>
                    <img src={profileData.avatar_url} className="w-48 h-48 bg-gray-900 bg-author-img bg-contain bg-no-repeat bg-center rounded-full"/>
                        
                </div>
                <div>
                    <p id="author-name" className="text-2xl text-center font-medium my-4 text-gray-800">{profileData.username}</p>
            ...
            <div id="related-posts" className="grid gap-2">
                ...
                {relatedPosts.map((post, index) => (
                    <div key={index} className="grid grid-cols-2 border rounded-lg">
                        <div className="md:col-span-2 lg:col-span-1">
                            <img src="img/aaa.png" className="w-full h-auto" alt="Related post" />
                        </div>
