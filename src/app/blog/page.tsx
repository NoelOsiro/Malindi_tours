...
export default function Home() {
  ...
  return (
	...
	<div className="container grid grid-cols-12 mx-auto gap-y-6 md:gap-10">
		...
		<div className="relative flex col-span-12 bg-center bg-no-repeat bg-cover dark:bg-gray-500 xl:col-span-6 lg:col-span-5 md:col-span-9 min-h-96" style="background-image: url('https://source.unsplash.com/random/239x319');">
