      ...
      <div className="container mx-auto px-2 mt-24">
        <section className="grid md:grid-cols-3 mt-12">
            ...
            <main className="col-span-2 relative md:mr-2">
             <h1 className="text-3xl font-bold text-gray-800">For Loops in Javascript</h1>
             ...
             <div className="flex justify-center border">
                 <img src="img/aaa.png" className="cursor-pointer" alt="placeholder tag"/>
             </div>
            ...
            <aside className="col-span-2 md:col-span-1 mt-4 md:mt-0">
                <div className="mb-8 ">
                    <p className="text-3xl font-semibold border-l-4 border-gray-800 pl-2 my-8 text-gray-700">Explore Categories</p>
                    <ul className="ml-3 text-lg font-semibold text-gray-700">
                        <li className="border py-2 px-2 mt-2 mb-1 cursor-pointer hover:text-gray-900 rounded-sm flex justify-between">Javascript <span className="text-gray-900">1</span></li>
                        <li className="border py-2 px-2 mt-2 mb-1 cursor-pointer hover:text-gray-900 rounded-sm flex justify-between">Node Js <span className="text-gray-900">5</span></li>
                        <li className="border py-2 px-2 mt-2 mb-1 cursor-pointer hover:text-gray-900 rounded-sm flex justify-between">React Js <span className="text-gray-900">11</span></li>
                        <li className="border py-2 px-2 mt-2 mb-1 cursor-pointer hover:text-gray-900 rounded-sm flex justify-between">CSS <span className="text-gray-900">8</span></li>
                    </ul>
                </div>
                <div id="author-card" className="flex flex-col items-center my-8">
                    <p className="text-3xl font-semibold border-l-4 my-8 border-gray-800 pl-2 text-gray-700 self-start">About Author</p>

                    <div >
                        <div className="w-48 h-48 bg-gray-900 bg-author-img bg-contain bg-no-repeat bg-center rounded-full"></div>
                    </div>
                    <div>
                        <p id="author-name" className="text-2xl text-center font-medium my-4 text-gray-800">Sarthak Kaushik</p>
                ...
                <div id="related-posts" className="grid gap-2">
                    ...
                    <div className="grid grid-cols-2   border rounded-lg">
                        <div className=" md:col-span-2 lg:col-span-1">
                            <img src="img/aaa.png" className="w-full h-auto" />
                        </div>
